...
DP.Walks = {
  ...
  ["Trevor"] = {"move_p_m_two"},
  ["Wide"] = {"move_m@bag"},
  ["Tentwalk"] = {"move_f@flee@b"},
  ["Tentwalk2"] = {"move_f@flee@b"},
  ["Tentwalk3"] = {"move_f@chubby@a"},
  ["Tentwalk4"] = {"move_m@generic"},
...
DP.Dances = {
   ...
   ["Tentdance1"] = {"anim@amb@nightclub@dancers@club_ambientpeds@med-hi_intensity", "mi-hi_amb_club_10_v1_male^6", "Tentdance1", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["Tentdance2"] = {"amb@code_human_in_car_mp_actions@dance@bodhi@ds@base", "idle_a_fp", "Tentdance2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["Tentdance3"] = {"amb@code_human_in_car_mp_actions@dance@bodhi@rds@base", "idle_b", "Tentdance3", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["Tentdance4"] = {"amb@code_human_in_car_mp_actions@dance@std@ds@base", "idle_a", "Tentdance4", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["Tentdance5"] = {"anim@mp_player_intcelebrationfemale@uncle_disco", "uncle_disco", "Tentdance5", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["Tentdance6"] = {"anim@mp_player_intcelebrationfemale@raise_the_roof", "raise_the_roof", "Tentdance6", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["Tentdance7"] = {"anim@mp_player_intcelebrationmale@cats_cradle", "cats_cradle", "Tentdance7", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ...
   ["dance10"] = {"mini@strip_club@private_dance@part2", "priv_dance_p2", "DANCE10", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance11"] = {"anim@amb@nightclub@dancers@black_madonna_entourage@", "hi_dance_facedj_09_v2_male^5", "DANCE11", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance12"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_mi_15_robot_laz", "DANCE12", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance13"] = {"mini@strip_club@lap_dance@ld_girl_a_song_a_p1", "ld_girl_a_song_a_p1_f", "DANCE13", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance14"] = {"anim@amb@casino@mini@dance@dance_solo@female@var_b@", "high_center_up", "DANCE14", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance15"] = {"anim@amb@casino@mini@dance@dance_solo@female@var_b@", "med_center_up", "DANCE15", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance16"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_a@", "med_center", "DANCE16", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance17"] = {"anim@amb@nightclub@mini@dance@dance_solo@male@var_a@", "low_center", "DANCE17", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance18"] = {"anim@amb@nightclub@dancers@solomun_entourage@", "mi_dance_prop_15_v1_male^5", "DANCE18", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance19"] = {"anim@amb@nightclub@dancers@dixon_entourage@", "mi_dance_facedj_15_v1_male^4", "DANCE19", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance20"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "low_right_up", "DANCE20", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance21"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "med_center", "DANCE21", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance22"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "med_center_down", "DANCE22", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance23"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "med_center_up", "DANCE23", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance24"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "med_left", "DANCE24", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance25"] = {"anim@amb@nightclub@mini@dance@dance_solo@male@var_a@", "med_center_up", "DANCE25", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance26"] = {"anim@amb@nightclub@mini@dance@dance_solo@male@var_a@", "med_right_up", "DANCE26", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance27"] = {"anim@amb@nightclub@mini@dance@dance_solo@male@var_a@", "high_center_up", "DANCE27", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance28"] = {"anim@amb@nightclub@mini@dance@dance_solo@male@var_a@", "med_right_down", "DANCE28", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance29"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "med_center_up", "DANCE29", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance30"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "med_center_down", "DANCE30", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance31"] = {"anim@amb@nightclub@mini@dance@dance_solo@male@var_b@", "med_center", "DANCE31", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance32"] = {"anim@amb@nightclub@mini@dance@dance_solo@male@var_a@", "med_right_down", "DANCE32", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance33"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "med_right", "DANCE33", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance34"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "med_right_up", "DANCE34", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dance35"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "med_left_up", "DANCE35", AnimationOptions =
   {
       EmoteLoop = true,
   }},
}
...
DP.Emotes = {
   ...
   ["facepalm5"] = {"random@car_thief@agitated@idle_a", "agitated_idle_b", "Facepalm 5", AnimationOptions =
   {
     EmoteMoving = true,
     EmoteDuration = 8000
   }},
   ["facepalm6"] = {"random@car_thief@agitated@idle_a", "agitated_idle_c", "Facepalm 6", AnimationOptions =
   {
     EmoteMoving = true,
     EmoteDuration = 8000
   }},
   ["facepalm7"] = {"anim@mp_player_intupperface_palm", "idle_a_fp", "Facepalm 7", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,
   }},
   ["facepalm8"] = {"anim@mp_player_intupperface_palm", "exit", "Facepalm 8", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 4000
   }},
   ["facepalm9"] = {"anim@mp_player_intcelebrationmale@face_palm", "face_palm", "Facepalm 9", AnimationOptions =
   {
       EmoteMoving = false,
       EmoteLoop = false,
   }},
   ...
   ["lean6"] = {"amb@world_human_leaning@male@wall@back@hands_together@idle_a", "idle_c", "Lean 6", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["lean7"] = {"amb@world_human_leaning@male@wall@back@foot_up@idle_a", "idle_b", "Lean 7", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["lean8"] = {"amb@world_human_leaning@male@wall@back@foot_up@idle_a", "idle_c", "Lean 8", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["Tent"] = {"missarmenian3_tryopendoor", "lockeddoor_tryopen_stealth", "Tent", AnimationOptions =
   {
       EmoteLoop = false,
   }},
   ["Tent2"] = {"missheistfbi3b_ig4", "shoot_opendoor_guard", "Tent 2", AnimationOptions =
   {
       EmoteLoop = false,
   }},
   ["Tent3"] = {"missheistfbisetup1", "unlock_enter_janitor", "Tent 3", AnimationOptions =
   {
       EmoteLoop = false,
   }},
   ["Tent4"] = {"mp_common", "givetake1_b", "Tent 4", AnimationOptions =
   {
       EmoteLoop = false,
   }},
   ["Tent5"] = {"switch@franklin@bed", "bed_reading_getup", "Tent 5", AnimationOptions =
   {
       EmoteLoop = false,
   }},
   ["Tent8"] = {"amb@prop_human_bbq@male@idle_a", "idle_b", "give", AnimationOptions =
   {
       EmoteLoop = false,
   }},
   ["Tent6"] = {"creatures@rottweiler@amb@world_dog_barking@idle_a", "idle_a", "Tent 6", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   --[[["Tent7"] = {"creatures@rottweiler@amb@world_dog_barking@idle_a", "idle_a", "Tent  7", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["Tent8"] = {"creatures@rottweiler@amb@world_dog_sitting@base", "base", "Tent 8", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["Tent9"] = {"creatures@rottweiler@amb@world_dog_sitting@idle_a", "idle_a", "Tent 9", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["Tent10"] = {"creatures@rottweiler@indication@", "indicate_high", "Tent 10", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["Tent11"] = {"creatures@rottweiler@melee@", "dog_takedown_from_back", "Tent 11", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["Tent12"] = {"creatures@rottweiler@melee@streamed_taunts@", "taunt_02", "Tent 12", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["Tent13"] = {"creatures@rottweiler@swim@", "swim", "Tent13", AnimationOptions =
   {
       EmoteLoop = true,
   }},]]--
   ["Tent7"] = {"anim@mp_player_intcelebrationmale@cry_baby", "cry_baby", "Tent 7", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["Tent8"] = {"missheist_jewel", "fp_smash_case_necklace_skull", "give", AnimationOptions =
   {
       EmoteLoop = false,
   }},
   ["Tent9"] = {"amb@prop_human_bbq@male@idle_a", "idle_b", "Tent9", AnimationOptions =
   {
       EmoteLoop = false,
   }},
  --[[["Tent7"] = {"amb@world_human_clipboard@male@idle_a", "idle_c", "kepo", AnimationOptions =
   {
       EmoteLoop = false,
   }},
   ["Tent8"] = {"amb@prop_human_atm@male@idle_a", "idle_b", "ahmantap", AnimationOptions =
   {
       EmoteLoop = false,
   }},--]]
   ["situp"] = {"amb@world_human_sit_ups@male@idle_a", "idle_a", "Sit sUp", AnimationOptions =
   {
       EmoteLoop = true,
   }},
