...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = {['cash'] = 9999999999999, ['bank'] = 599999999000, ['crypto'] = 9999999999999990} -- ['type'] = startamount - Add or remove money types for your server (for ex. ['blackmoney'] = 0), remember once added it will not be removed from the database!
