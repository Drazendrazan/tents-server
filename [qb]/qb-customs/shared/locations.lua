...
Config.Locations = {
    ['Innocence'] = {
        ...
        blip = {
            label = 'Bennys Motorworks',
            coords = vector3(824.5, -966.51, 25.84),
            sprite = 72,
            scale = 0.65,
            color = 0,
            display = 4,
        ...
        zones = {
            { coords = vector3(836.17, -985.45, 25.99), length = 6.0, width = 4.0, heading = 268.78, minZ = 25.65, maxZ = 29.65 },
            { coords = vector3(835.98, -976.96, 25.99), length = 6.0, width = 4.0, heading = 269.86, minZ = 24.99, maxZ = 28.99 },
        }
    },
